...
@Tag(name = "User Management", description = "User management — ADMIN_BRANCHES role only (RECEPTION and CALL_CENTER accounts)")
@SecurityRequirement(name = "bearerAuth")
@PreAuthorize("hasRole('ADMIN_BRANCHES')")   // ADMIN_BRANCHES exclusively manages users
