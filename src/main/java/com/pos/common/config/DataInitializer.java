...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() == 0) {
            ...
            createUser("admin_pos",         "123456789",         "System Admin",      Role.ADMIN,         null);
            createUser("cashier",       "123456789",       "Default Cashier",   Role.CASHIER,       null);
            createUser("admin_center", "123456789", "Branch Manager",    Role.ADMIN_BRANCHES, null);
